...
This is a simple tool to help you permanently set up any NFS Shares on your SteamOS device. After using this tool, your drive will be ready automatically every time you start your device, and you won't have to worry about it again.
...
If double-clicking the file opens it in a text editor instead of running it, your system needs you to give it permission once. To do this, open a Terminal and run this one command: `chmod +x ~/Desktop/Easy-NFS-Mount-Tool.desktop`. After that, it will work with a double-click forever.
